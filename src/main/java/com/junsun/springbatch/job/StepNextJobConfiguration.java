...
public class StepNextJobConfiguration {
	...
	//program arguments -> version=1 변경
	
	//program arguments ->  --job.name=stepNextJob version=2 변경
	//정확히 stepNextJob만 실행 -> 실제 운영 java -jar batch-application.jar --job.name=simpleJob
